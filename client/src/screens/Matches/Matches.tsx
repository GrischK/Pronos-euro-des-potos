        ...
        <div className={styles.macthes}>
            <TracingBeam className="px-6">
                ...
                <div className={styles.groupMatches}>
                    {groupMatches && groupMatches.map((groupMatch) => {
                        const matchUserPrediction = predictionList?.find((prediction: any) => prediction.matchId === groupMatch.id);
                        return (
                            <GradientCard
                ...
                <div className={styles.groupMatches}>
                    {roundOf16 && roundOf16.map((roundOf16Match) => {
                        const matchUserPrediction = predictionList?.find((prediction: any) => prediction.matchId === roundOf16Match.id);
                        return (
                            <GradientCard
                                className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-zinc-900" style={{width: "20vw"}}
                ...
                <div className={styles.groupMatches}>
                    {quarterFinals && quarterFinals.map((quarterFinalsMatch) => {
                        const matchUserPrediction = predictionList?.find((prediction: any) => prediction.matchId === quarterFinalsMatch.id);
                        return (
                            <GradientCard
                                className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-zinc-900" style={{width: "20vw"}}
                ...
                <div className={styles.groupMatches}>
                    {semiFinals && semiFinals.map((semiFinalsMatch) => {
                        const matchUserPrediction = predictionList?.find((prediction: any) => prediction.matchId === semiFinalsMatch.id);
                        return (
                            <GradientCard
                                className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-zinc-900" style={{width: "20vw"}}
                ...
                <div className={styles.groupMatches}>
                    {final && final.map((finalMatch) => {
                        const matchUserPrediction = predictionList?.find((prediction: any) => prediction.matchId === finalMatch.id);
                        return (
                            <GradientCard
                                className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-zinc-900" style={{width: "20vw"}}
                                key={finalMatch.id}
