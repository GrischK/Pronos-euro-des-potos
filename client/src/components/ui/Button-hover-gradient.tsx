...
export default function ButtonHoverGradient({
  children,
  onClick,
}: ButtonHoverGradientProps) {
  const BottomGradient = () => {
    return (
      <>
        <span className="group-hover/btn:opacity-100 block transition duration-500 opacity-0 absolute h-px -bottom-px inset-x-0 bg-gradient-to-r from-transparent via-cyan-500 to-transparent transform -translate-x-1/2 left-1/2 w-4/5" />
